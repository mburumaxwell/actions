...
var zephyr_version_file_exports = {};
__export(zephyr_version_file_exports, {
  run: () => run
});
module.exports = __toCommonJS(zephyr_version_file_exports);
...
function run() {
  try {
    ...
    const extraversion = parsed.prerelease.length > 0 ? parsed.prerelease.join(".").toLowerCase().replace(/[^a-z0-9.-]/g, "") : "";
    const lines = [
    ...
    if ((0, import_node_fs.existsSync)(destination)) (0, import_node_fs.rmSync)(destination);
    (0, import_node_fs.writeFileSync)(destination, contents, "utf-8");
    info(`\u2705 Generated VERSION file for ${raw} at ${destination}`);
...
*/
//# sourceMappingURL=zephyr-version-file.js.map